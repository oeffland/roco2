...
export SCOREP_METRIC_METRICQ_PLUGIN_TIMEOUT="500s"
...
#export SCOREP_METRIC_METRICQ_PLUGIN="elab.ariel.power,elab.ariel.s0.dram.power.100Hz"
...
#export SCOREP_METRIC_PLUGINS=x86_energy_plugini,metricq_plugin  #automatically loaded
